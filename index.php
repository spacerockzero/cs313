<?php include('modules/header-top.php');?>
    ...
    <title>Jakob Anderson >> CS313 [Web Engineering II] | Home</title>
...
<?php include('modules/frame-top.php');?>
          <div class="cf hero-unit">
            ...
            <img class="hero_img" src="img/Jakob_Anderson.jpg" alt="Jakob Anderson, Interactive Engineer and Web Developer">
